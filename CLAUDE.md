...
4. Walk `.claude/prompts/review.md` check-by-check (checks 1–24) and apply each one honestly to the diff. Triggers (label-based, content-based) are the same; the difference is that you are the reviewer.
