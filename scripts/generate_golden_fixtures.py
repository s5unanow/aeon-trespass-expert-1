...
def main() -> None:
    ...
    write_json("native_page.p0001.json", {
    ...
    write_json("symbol_matches.p0001.json", {
    ...
    write_json("page_ir.en.p0001.json", {
        ...
        "blocks": [
            {
                ...
                "level": 2,
                "children": [
                    {"type": "text", "text": "Attack Test", "marks": [], "lang": "en",
                     "source_word_ids": []},
                ],
                "translatable": True,
                "style_hint": None,
            ...
            },
            {
                ...
                "bbox": None,
                "children": [
                    {"type": "text", "text": "Gain 1 ", "marks": [], "lang": "en",
                     "source_word_ids": []},
                    {"type": "icon", "symbol_id": "sym.progress",
                     "instance_id": "syminst.p0001.01", "bbox": None,
                     "display_hint": {}, "source_asset_id": ""},
                    {"type": "text", "text": " Progress.", "marks": [], "lang": "en",
                     "source_word_ids": []},
                ],
                "translatable": True,
                "style_hint": None,
    ...
    write_json("translation_batch.p0001.json", {
        ...
        "segments": [
            ...
            },
            {
                ...
                "context": {"page_id": "p0001", "section_path": [], "prev_heading": "Attack Test"},
    ...
    write_json("translation_result.p0001.json", {
        ...
        "segments": [
            {
                "segment_id": "p0001.b001",
                "target_inline": [
                    {"type": "text", "text": "Проверка атаки", "marks": [], "lang": "ru",
                     "source_word_ids": []},
                ],
            ...
            },
            {
                "segment_id": "p0001.b002",
                "target_inline": [
                    {"type": "text", "text": "Получите 1 ", "marks": [], "lang": "ru",
                     "source_word_ids": []},
                    {"type": "icon", "symbol_id": "sym.progress",
                     "instance_id": "syminst.p0001.01", "bbox": None,
                     "display_hint": {}, "source_asset_id": ""},
                    {"type": "text", "text": " Прогресс.", "marks": [], "lang": "ru",
                     "source_word_ids": []},
                ],
                "concept_realizations": [
    ...
    write_json("page_ir.ru.p0001.json", {
        "schema_version": "page_ir.v1",
        "document_id": "walking_skeleton",
        "page_id": "p0001",
        "page_number": 1,
    ...
    write_json("render_page.p0001.json", {
    ...
    write_json("glossary_payload.json", {
        "document_id": "walking_skeleton",
        "entries": [
            {
